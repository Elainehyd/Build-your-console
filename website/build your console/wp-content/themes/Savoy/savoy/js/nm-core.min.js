...
setTimeout(function(){b("#nm-cart-panel-loader").removeClass("fade-out show")},200)},widgetPanelCartHideScrollbar:function(){this.$widgetPanel.children(".nm-widget-panel-inner").css("marginRight","-"+this.scrollbarWidth+"px")},widgetPanelCartRemoveProduct:function(a){var c=this;a=b(a);var d=a.closest("li"),e=d.parent("ul");a=a.data("cart-item-key");d.closest("li").addClass("loading");c.cartPanelAjax=b.ajax({type:"POST",url:nm_wp_vars.ajaxUrl,data:{action:"nm_cart_panel_remove_product",cart_item_key:a},
dataType:"json",error:function(a,b,c){console.log("NM: AJAX error - widgetPanelCartRemoveProduct() - "+c);d.closest("li").removeClass("loading")},complete:function(a){c.cartPanelAjax=null;var f=a.responseJSON;f&&"1"===f.status?(d.css({"-webkit-transition":"0.2s opacity ease",transition:"0.2s opacity ease",opacity:"0"}),setTimeout(function(){d.css("display","block").slideUp(150,function(){d.remove();1==e.children("li").length&&b("#nm-cart-panel").addClass("nm-cart-panel-empty");c.shopReplaceFragments(f.fragments);
c.$body.trigger("added_to_cart",[f.fragments,f.cart_hash])})},160)):console.log("NM: Couldn't remove product from cart")}})},widgetPanelCartUpdate:function(a){var c=this;c.cartPanelAjax&&c.cartPanelAjax.abort();a.closest("li").addClass("loading");var d={action:"nm_cart_panel_update"};d[a.attr("name")]=a.val();c.cartPanelAjax=b.ajax({type:"POST",url:nm_wp_vars.ajaxUrl,data:d,dataType:"json",complete:function(a){c.cartPanelAjax=null;(a=a.responseJSON)&&"1"===a.status&&c.shopReplaceFragments(a.fragments);
b("#nm-cart-panel .cart_list").children(".loading").removeClass("loading")}})},shopReplaceFragments:function(a){var c;b.each(a,function(a,e){c=b(e);c.length&&b(a).replaceWith(c)})},quantityInputsBindButtons:function(a){var c=this;a.off("click.nmQty").on("click.nmQty",".nm-qty-plus, .nm-qty-minus",function(){var a=b(this),e=a.closest(".quantity").find(".qty"),g=parseFloat(e.val()),f=parseFloat(e.attr("max")),k=parseFloat(e.attr("min")),h=e.attr("step");g&&""!==g&&"NaN"!==g||(g=0);if(""===f||"NaN"===
f)f="";if(""===k||"NaN"===k)k=0;if("any"===h||""===h||void 0===h||"NaN"===parseFloat(h))h=1;a.hasClass("nm-qty-plus")?f&&(f==g||g>f)?e.val(f):(e.val(g+parseFloat(h)),c.quantityInputsTriggerEvents(e)):k&&(k==g||g<k)?e.val(k):0<g&&(e.val(g-parseFloat(h)),c.quantityInputsTriggerEvents(e))})},quantityInputsTriggerEvents:function(a){a.trigger("change");this.$document.trigger("nm_qty_change",a)},initPageIncludes:function(){var a=this;if(a.$pageIncludes.hasClass("row-full-height")){var c=function(){var c=
b(".nm-row-full-height:first");if(c.length){var d=a.$window.height(),e=c.offset().top,f;d>e&&(f=100-e/(d/100),c.css("min-height",f+"vh"))}};c();var d=null;a.$window.bind("resize.nmRow",function(){d&&clearTimeout(d);d=setTimeout(function(){c()},250)})}!a.isTouch&&a.$pageIncludes.hasClass("video-background")&&b(".nm-row-video").each(function(){var a=b(this),c=a.data("video-url");c&&(c=vcExtractYoutubeId(c))&&insertYoutubeVideoAsBackground(a,c)});a.$window.load(function(){if(a.$pageIncludes.hasClass("blog-grid")){var c=
...
function(c){c.preventDefault();a.shopExternalGetPage(b(this).attr("href"))});a.$pageIncludes.hasClass("product_categories_packery")&&a.$window.load(function(){for(var a=0;a<e.length;a++){var c=b(e[a]).children(".woocommerce").children("ul");c.packery({itemSelector:".product-category",gutter:0,isInitLayout:!1});c.packery("once","layoutComplete",function(){c.closest(".nm-product-categories").removeClass("nm-loader");c.addClass("show")});c.packery()}})}if(a.$pageIncludes.hasClass("lightbox")){var g,
f,k;b(".nm-lightbox").each(function(){b(this).bind("click",function(a){a.preventDefault();a.stopPropagation();g=b(this);f=g.data("mfp-type");k={mainClass:"nm-wp-gallery-popup nm-mfp-zoom-in",closeMarkup:'<a class="mfp-close nm-font nm-font-close2"></a>',removalDelay:180,type:f,closeBtnInside:!1,image:{titleSrc:"data-mfp-title"}};k.closeOnContentClick="inline"==f?!1:!0;g.magnificPopup(k).magnificPopup("open")})})}}};b.nmTheme=l.prototype;b(document).ready(function(){new l})})(jQuery);